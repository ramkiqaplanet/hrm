...
public class WorkingWithRobetClass
{
public static void main(String[] args) throws Exception 
{
	...
	//create object for Robet
	Robot Rt=new Robot();
	//click on photp
	WebElement Browser=Driver.findElement(By.id("photofile"));
	Browser.click();
	//load image path any file
	StringSelection ss=new StringSelection("D:\\Ramki\\PicsArt_1352728364546.jpg");
	...
	Rt.delay(1000);
	{
	System.out.println("image succes");
	}
