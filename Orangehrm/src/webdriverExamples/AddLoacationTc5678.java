package webdriverExamples;
	...
	public class AddLoacationTc5678 
	{
	...
	//veri lacation table
		...
		Driver.findElement(By.xpath("//table[@class='data-table']/tbody/tr["+i+"]/td[3]")).click();
		break;
		}}
		//Edit Location
		...
		for(int i=0; i<=rc1; i++){
			String Name=Driver.findElement(By.xpath("//table[@class='data-table']/tbody/tr["+i+"]/td[3]")).getText();
			if(Name.equals("Vbbcv")){
				Driver.findElement(By.xpath("//table[@class='data-table']/tbody/tr["+i+"]/td[3]")).click();
				break;
			}
		}
